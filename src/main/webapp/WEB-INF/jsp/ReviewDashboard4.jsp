...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Lenovo Yoga C640 Reviews</h2>
			</div>
		</div>
		<div id="featured">
		...
		<table align="center">
			<tbody>
			<c:forEach var="review4" items="${reviews4}">
			<tr>
				<th colspan="2" align="left" bgcolor="grey">${review4.username}</th>
			</tr>
			<tr>
				<th align="left">Display :</th> <td align="left">${review4.display}</td>
			</tr>
			<tr>
				<th align="left">Performance :</th> <td align="left">${review4.performance}</td>
			</tr>
			<tr>
				<th align="left">Battery :</th> <td align="left">${review4.battery}</td>
			</tr>
			<tr>
				<th align="left">Ram :</th> <td align="left">${review4.ram}</td>
			</tr>
			<tr>
				<th align="left">Storage :</th> <td align="left">${review4.storage}</td>
			</tr>
			<tr>
				<th align="left">Interfaces :</th> <td align="left">${review4.interfaces}</td>
			</tr>
			</c:forEach>
			</tbody>
			</table>
