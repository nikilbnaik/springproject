...
<div id="page" class="container">
	...
	<div id="main">
		<form method="POST" action="save-review4">
		<div id="banner">
		...
		<div id="featured">
			...
			<td align="right"><textarea rows="10" cols="56" name="display" value="${Review4.display }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Performance :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="performance" value="${Review4.performance }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Battery Backup :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="battery" value="${Review4.battery }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>RAM :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="ram" value="${Review4.ram }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Storage :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="storage" value="${Review4.storage }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Interface :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="interfaces" value="${Review4.interfaces }"></textarea></td>
			</tr>
			</table>
                        <br /><br />
