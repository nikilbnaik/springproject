...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Dell Alienware M15 Reviews</h2>
			</div>
		</div>
		<div id="featured">
		...
		<table align="center">
			<tbody>
			<c:forEach var="review5" items="${reviews5}">
			<tr>
				<th colspan="2" align="left" bgcolor="grey">${review5.username}</th>
			</tr>
			<tr>
				<th align="left">Display :</th> <td align="left">${review5.display}</td>
			</tr>
			<tr>
				<th align="left">Performance :</th> <td align="left">${review5.performance}</td>
			</tr>
			<tr>
				<th align="left">Battery :</th> <td align="left">${review5.battery}</td>
			</tr>
			<tr>
				<th align="left">Ram :</th> <td align="left">${review5.ram}</td>
			</tr>
			<tr>
				<th align="left">Storage :</th> <td align="left">${review5.storage}</td>
			</tr>
			<tr>
				<th align="left">Interfaces :</th> <td align="left">${review5.interfaces}</td>
			</tr>
			</c:forEach>
			</tbody>
			</table>
