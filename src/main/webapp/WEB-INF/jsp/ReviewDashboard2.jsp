...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Lenovo IdeaPad 81H30053IN Reviews</h2>
			</div>
		</div>
		<div id="featured">
		...
		<table align="center">
			<tbody>
			<c:forEach var="review2" items="${reviews2}">
			<tr>
				<th colspan="2" align="left" bgcolor="grey">${review2.username}</th>
			</tr>
			<tr>
				<th align="left">Display :</th> <td align="left">${review2.display}</td>
			</tr>
			<tr>
				<th align="left">Performance :</th> <td align="left">${review2.performance}</td>
			</tr>
			<tr>
				<th align="left">Battery :</th> <td align="left">${review2.battery}</td>
			</tr>
			<tr>
				<th align="left">Ram :</th> <td align="left">${review2.ram}</td>
			</tr>
			<tr>
				<th align="left">Storage :</th> <td align="left">${review2.storage}</td>
			</tr>
			<tr>
				<th align="left">Interfaces :</th> <td align="left">${review2.interfaces}</td>
			</tr>
			</c:forEach>
			</tbody>
			</table>
