...
<div id="page" class="container">
	...
	<div id="main">
		<form action="/feed5" method="get">
		<div id="banner">
			<img src="static/main/images/logo.png" alt="" class="image-full" />
		</div>
		<div id="welcome">
			<div class="title">
				<h2>Dell Alienware M15</h2>
			</div>
		</div>
		<div id="featured">
			<img src="static/main/images/pic05.jpg" width="800" height="400"></img>
			...
			<table align="left">
				...
				<tr align="left">
					<td>Processor</td>
					<td>4.5 GHz Hexa-core Intel Core i7-9750H 9th Gen</td>
				</tr>
				<tr align="left">
