...
<div id="page" class="container">
	...
	<div id="main">
		...
		<table align="center">
			<tbody>
			<c:forEach var="review3" items="${reviews3}">
			<tr>
				<th colspan="2" align="left" bgcolor="grey">${review3.username}</th>
			</tr>
			<tr>
				<th align="left">Display :</th> <td align="left">${review3.display}</td>
			</tr>
			<tr>
				<th align="left">Performance :</th> <td align="left">${review3.performance}</td>
			</tr>
			<tr>
				<th align="left">Battery :</th> <td align="left">${review3.battery}</td>
			</tr>
			<tr>
				<th align="left">Ram :</th> <td align="left">${review3.ram}</td>
			</tr>
			<tr>
				<th align="left">Storage :</th> <td align="left">${review3.storage}</td>
			</tr>
			<tr>
				<th align="left">Interfaces :</th> <td align="left">${review3.interfaces}</td>
			</tr>
			</c:forEach>
			</tbody>
			</table>
