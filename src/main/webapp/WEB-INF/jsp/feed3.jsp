...
<div id="page" class="container">
	...
	<div id="main">
		<form method="POST" action="save-review3">
		<div id="banner">
		...
		<div id="featured">
			<img src="static/main/images/pic07.jpg" width="800" height="400"></img>
			<br /><br />
			...
			<td align="right"><textarea rows="10" cols="56" name="display" value="${Review3.display }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Performance :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="performance" value="${Review3.performance }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Battery Backup :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="battery" value="${Review3.battery }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>RAM :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="ram" value="${Review3.ram }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Storage :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="storage" value="${Review3.storage }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Interface :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="interfaces" value="${Review3.interfaces }"></textarea></td>
			</tr>
			</table>
                        <br /><br />
