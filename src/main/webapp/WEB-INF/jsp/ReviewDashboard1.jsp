...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Dell Alienware Area-51M Reviews</h2>
			</div>
		</div>
		<div id="featured">
		...
		<table align="center">
			...
			<tr>
				<th colspan="2" align="left" bgcolor="grey">${review.username}</th>
			</tr>
			<tr>
				<th align="left">Display :</th> <td align="left">${review.display}</td>
			</tr>
			<tr>
				<th align="left">Performance :</th> <td align="left">${review.performance}</td>
			</tr>
			<tr>
				<th align="left">Battery :</th> <td align="left">${review.battery}</td>
			</tr>
			<tr>
				<th align="left">Ram :</th> <td align="left">${review.ram}</td>
			</tr>
			<tr>
				<th align="left">Storage :</th> <td align="left">${review.storage}</td>
			</tr>
			<tr>
				<th align="left">Interfaces :</th> <td align="left">${review.interfaces}</td>
			</tr>
			</c:forEach>
			</tbody>
			</table>
