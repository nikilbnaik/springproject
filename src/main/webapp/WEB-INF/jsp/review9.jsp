...
<div id="page" class="container">
	...
	<div id="main">
		<form action="/feed9" method="get">
		<div id="banner">
			<img src="static/main/images/logo.png" alt="" class="image-full" />
		</div>
		<div id="welcome">
			<div class="title">
				<h2>HP 13-ap0121tu</h2>
			</div>
		</div>
		<div id="featured">
			<img src="static/main/images/pic09.jpg" width="800" height="400"></img>
			...
			<table align="left">
				...
				<tr align="left">
					<td>Processor</td>
					<td>1.6 GHz 8th Generation Intel Core i5-8265U Processor</td>
				</tr>
				<tr align="left">
