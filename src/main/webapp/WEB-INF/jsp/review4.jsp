...
<div id="page" class="container">
	...
	<div id="main">
		<form action="/feed4" method="get">
		<div id="banner">
			<img src="static/main/images/logo.png" alt="" class="image-full" />
		</div>
		<div id="welcome">
			<div class="title">
				<h2>Lenovo Yoga C640</h2>
			</div>
		</div>
		<div id="featured">
			<img src="static/main/images/pic03.jpg" width="800" height="400"></img>
			...
			<table align="left">
				...
				<tr align="left">
					<td>Processor</td>
					<td>1.6 GHz Intel Core i5-10210U 10th Gen</td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
					...
					<td>8 GB DDR4-2400 DDR4 SDRAM 2400 MHz</td>
				</tr>
				<tr align="left">
