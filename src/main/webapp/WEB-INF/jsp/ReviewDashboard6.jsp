...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Apple MacBook Pro Reviews</h2>
			</div>
		</div>
		<div id="featured">
		...
		<table align="center">
			<tbody>
			<c:forEach var="review6" items="${reviews6}">
			<tr>
				<th colspan="2" align="left" bgcolor="grey">${review6.username}</th>
			</tr>
			<tr>
				<th align="left">Display :</th> <td align="left">${review6.display}</td>
			</tr>
			<tr>
				<th align="left">Performance :</th> <td align="left">${review6.performance}</td>
			</tr>
			<tr>
				<th align="left">Battery :</th> <td align="left">${review6.battery}</td>
			</tr>
			<tr>
				<th align="left">Ram :</th> <td align="left">${review6.ram}</td>
			</tr>
			<tr>
				<th align="left">Storage :</th> <td align="left">${review6.storage}</td>
			</tr>
			<tr>
				<th align="left">Interfaces :</th> <td align="left">${review6.interfaces}</td>
			</tr>
			</c:forEach>
			</tbody>
			</table>
