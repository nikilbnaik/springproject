...
<div id="page" class="container">
	...
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2>Dell Inspiron 5570 Reviews</h2>
			</div>
		</div>
		<div id="featured">
		...
		<table align="center">
			<tbody>
			<c:forEach var="review7" items="${reviews7}">
			<tr>
				<th colspan="2" align="left" bgcolor="grey">${review7.username}</th>
			</tr>
			<tr>
				<th align="left">Display :</th> <td align="left">${review7.display}</td>
			</tr>
			<tr>
				<th align="left">Performance :</th> <td align="left">${review7.performance}</td>
			</tr>
			<tr>
				<th align="left">Battery :</th> <td align="left">${review7.battery}</td>
			</tr>
			<tr>
				<th align="left">Ram :</th> <td align="left">${review7.ram}</td>
			</tr>
			<tr>
				<th align="left">Storage :</th> <td align="left">${review7.storage}</td>
			</tr>
			<tr>
				<th align="left">Interfaces :</th> <td align="left">${review7.interfaces}</td>
			</tr>
			</c:forEach>
			</tbody>
			</table>
