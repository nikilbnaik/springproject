...
<div id="page" class="container">
	...
	<div id="main">
		<form method="POST" action="save-review7">
		<div id="banner">
			<img src="static/main/images/logo.png" alt="" class="image-full" />
		</div>
		<div id="welcome">
			<div class="title">
				<h2>Dell Inspiron 5570</h2>
			</div>
		</div>
		<div id="featured">
			<img src="static/main/images/pic04.jpg" width="800" height="400"></img>
			<br /><br />
			...
			<td align="right"><textarea rows="10" cols="56" name="display" value="${Review7.display }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Performance :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="performance" value="${Review7.performance }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Battery Backup :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="battery" value="${Review7.battery }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>RAM :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="ram" value="${Review7.ram }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Storage :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="storage" value="${Review7.storage }"></textarea></td>
			</tr>
			<tr>
			<td align="left"><h2>Interface :</h2></td>
			<td align="right"><textarea rows="10" cols="56" name="interfaces" value="${Review7.interfaces }"></textarea></td>
			</tr>
			</table>
                        <br /><br />
